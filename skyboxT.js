...
function init() 
{
  ...
  const radius = 300;
  const widhtsegment = 200;
  const heightsegments = 200;
  const thetaLength = 3.11;
  ...
  const texture = new THREE.TextureLoader().load('https://cdn.glitch.global/a412104d-0482-48b2-a4e0-2b3170e89fea/photo1698240907%20(1).jpeg?v=1698241565274' );
